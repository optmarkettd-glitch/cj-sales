    ...
    >
      ...
      <div className="space-y-6">
        ...
        {service.stages && service.stages.length > 0 ? (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mb-3 text-graphite">
                Этапы работы:
              </h3>
            ...
            {service.extraServices && service.extraServices.length > 0 && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {service.extraServices.map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between px-4 py-3 rounded-2xl bg-white border border-gray-200"
                    >
